...
def welcome():
    print("\nWelcome to the Genshin Impact guide!")
    print(
        "I am BOT_Paimon and I will be telling you about farming, characters, and rerolling in Genshin Impact.")
...
def question():
    res = input(
        "\nWhat are you looking for in Genshin Impact? \n[a] Introduction \n[b] Character \n[c] Rerolling \n> ")
    res = res.lower()
    if res == "a":
        return introduction()
    elif res == "b":
...
def introduction():
    res = input("\nWhat introduction do you need with Genshin Impact? \n[a] The bot \n[b] The game \n> ")
    res = res.lower()
    if res == "a":
        return paimonBot()
    elif res == "b":
...
def paimonBot():
    print("""
<BOT_Paimon> is an unofficial bot that is made for Genshin Impact. It was originally designed to help users that are new to Genshin Impact understand different characters easily.
Ironically, I have used it personally for myself as well whenever I needed a reminder of a build for a character in Genshin Impact. BOT_Paimon can be used to understand
characters and know how to reroll for different characters in Genshin Impact.""")


def gameInfo():
    print("""
Genshin Impact is an anime-style MMORPG that is open-world. You can explore the vast ruins and nations inside Teyvat and your mission is to save your sister. On your journey to saving your sister, 
meet new people around the different nations and help them out in order to get closer to saving your sister. """)


def character():
    res = input("\nWhich character do you need help with? \n> ")
    res = res.lower()
    if res == "aloy":
        return aloy()
    elif res == "albedo":
        ...
        print(
            "That isn't an existing Genshin Impact character yet. Try asking for a character that is currently in-game.")
        return character()


def aloy():
    res = input("\nWhat kind of help do you need with Aloy? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return aloyBuild()
    elif res == "b":
...
def albedo():
    res = input("\nWhat kind of help do you need with Albedo? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return albedoBuild()
    elif res == "b":
...
def amber():
    res = input("\nWhat kind of help do you need with Amber? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return amberBuild()
    elif res == "b":
...
def ayaka():
    res = input("\nWhat kind of help do you need with Ayaka? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return ayakaBuild()
    elif res == "b":
...
def beidou():
    res = input("\nWhat kind of help do you need with Beidou? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return beidouBuild()
    elif res == "b":
...
def diluc():
    res = input("\nWhat kind of help do you need with Diluc? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return dilucBuild()
    elif res == "b":
...
def diona():
    res = input("\nWhat kind of help do you need with Diona? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return dionaBuild()
    elif res == "b":
...
def eula():
    res = input("\nWhat kind of help do you need with Eula? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return eulaBuild()
    elif res == "b":
...
def fischl():
    res = input("\nWhat kind of help do you need with Fischl? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return fischlBuild()
    elif res == "b":
...
def ganyu():
    res = input("\nWhat kind of help do you need with Ganyu? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return ganyuBuild()
    elif res == "b":
...
def hutao():
    res = input("\nWhat kind of help do you need with Hu Tao? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return hutaoBuild()
    elif res == "b":
...
def jean():
    res = input("\nWhat kind of help do you need with Jean? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return jeanBuild()
    elif res == "b":
...
def kaeya():
    res = input("\nWhat kind of help do you need with Kaeya? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return kaeyaBuild()
    elif res == "b":
...
def kazuha():
    res = input("\nWhat kind of help do you need with Kazuha? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return kazuhaBuild()
    elif res == "b":
...
def keqing():
    res = input("\nWhat kind of help do you need with Keqing? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return keqingBuild()
    elif res == "b":
...
def klee():
    res = input("\nWhat kind of help do you need with Klee? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return kleeBuild()
    elif res == "b":
...
def kokomi():
    res = input("\nWhat kind of help do you need with Kokomi? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return kokomiBuild()
    elif res == "b":
...
def lisa():
    res = input("\nWhat kind of help do you need with Lisa? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return lisaBuild()
    elif res == "b":
...
def mona():
    res = input("\nWhat kind of help do you need with Mona? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return monaBuild()
    elif res == "b":
...
def noelle():
    res = input("\nWhat kind of help do you need with Noelle? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return noelleBuild()
    elif res == "b":
...
def qiqi():
    res = input("\nWhat kind of help do you need with Qiqi? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return qiqiBuild()
    elif res == "b":
...
def razor():
    res = input("\nWhat kind of help do you need with Razor? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return razorBuild()
    elif res == "b":
...
def sara():
    res = input("\nWhat kind of help do you need with Sara? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return saraBuild()
    elif res == "b":
...
def sayu():
    res = input("\nWhat kind of help do you need with Sayu? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return sayuBuild()
    elif res == "b":
...
def tartaglia():
    res = input("\nWhat kind of help do you need with Childe? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
...
def venti():
    res = input("\nWhat kind of help do you need with Venti? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return ventiBuild()
    elif res == "b":
...
def xiao():
    res = input("\nWhat kind of help do you need with Xiao? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return xiaoBuild()
    elif res == "b":
...
def xinyan():
    res = input("\nWhat kind of help do you need with Xinyan? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return xinyanBuild()
    elif res == "b":
...
def yanfei():
    res = input("\nWhat kind of help do you need with Yanfei? \n[a] General Build \n[b] Constellation \n[c] Ability \n> ")
    res.lower()
    if res == "a":
        return yanfeiBuild()
    elif res == "b":
...
def rerolling():
    rerollOrder = ["Create an account",
                   ...
                   "Type <GENSHINGIFT> in the redeem code",
                   "Collect your loot from Katheryne",
    ...
    tips = ["If you want to make a usable email quickly you can go to the website <https://www.emailondeck.com/>. \n\t\t ※ This website is completely safe and trustable.",
            "Remember to use an actual gmail after you get the character desired as temporary emails get deleted after around 48 hours. \n\t\t ※ You can do this by going to <https://account.mihoyo.com> and modifying the temp email."]

    print("\nRerolling: ")
    for i in enumerate(rerollOrder, start=1):
        print("\t", *i, sep=". ")
    print("※Tips!※: ")
    for ii in enumerate(tips, start=1):
        print("\t", *ii, sep=". ")
