...
def introduction():
    res = input("What introduction do you need with Genshin Impact? \n[a] The bot \n[b] The game \n> ")
    res = res.lower()
    if res == "a":
        return paimonBot()
    elif res == "b":
...
Ironically, I have used it personally for myself as well whenever I need a reminder of what kind of build is needed for a character in Genshin Impact. BOT_Paimon can be used to understand
characters and know how to reroll for different characters in Genshin Impact.""")


def gameInfo():
    print("""
Gensin Impact is an anime-style MMORPG that is open-world. You can explore the vast ruins and nations inside Teyvat and your mission is to save your sister. On your journey to saving your sister, 
